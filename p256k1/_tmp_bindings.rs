...
extern "C" {
    #[doc = " Clear a scalar to prevent the leak of sensitive data."]
    pub fn secp256k1_scalar_clear(r: *mut secp256k1_scalar);
}
extern "C" {
    #[doc = " Access bits from a scalar. All requested bits must belong to the same 32-bit limb."]
    pub fn secp256k1_scalar_get_bits(
...
extern "C" {
    #[doc = " Access bits from a scalar. Not constant time."]
    pub fn secp256k1_scalar_get_bits_var(
        a: *const secp256k1_scalar,
        offset: ::std::os::raw::c_uint,
        count: ::std::os::raw::c_uint,
    ) -> ::std::os::raw::c_uint;
...
extern "C" {
    #[doc = " Set a scalar from a big endian byte array and returns 1 if it is a valid\n  seckey and 0 otherwise."]
    pub fn secp256k1_scalar_set_b32_seckey(
        r: *mut secp256k1_scalar,
        bin: *const ::std::os::raw::c_uchar,
    ) -> ::std::os::raw::c_int;
}
extern "C" {
    #[doc = " Set a scalar to an unsigned integer."]
    pub fn secp256k1_scalar_set_int(r: *mut secp256k1_scalar, v: ::std::os::raw::c_uint);
}
extern "C" {
    #[doc = " Convert a scalar to a byte array."]
    pub fn secp256k1_scalar_get_b32(bin: *mut ::std::os::raw::c_uchar, a: *const secp256k1_scalar);
}
extern "C" {
    #[doc = " Add two scalars together (modulo the group order). Returns whether it overflowed."]
...
extern "C" {
    #[doc = " Conditionally add a power of two to a scalar. The result is not allowed to overflow."]
    pub fn secp256k1_scalar_cadd_bit(
        r: *mut secp256k1_scalar,
...
extern "C" {
    #[doc = " Multiply two scalars (modulo the group order)."]
...
extern "C" {
    #[doc = " Shift a scalar right by some amount strictly between 0 and 16, returning\n  the low bits that were shifted off"]
    pub fn secp256k1_scalar_shr_int(
        r: *mut secp256k1_scalar,
        n: ::std::os::raw::c_int,
    ) -> ::std::os::raw::c_int;
}
extern "C" {
    #[doc = " Compute the inverse of a scalar (modulo the group order)."]
    pub fn secp256k1_scalar_inverse(r: *mut secp256k1_scalar, a: *const secp256k1_scalar);
}
extern "C" {
    #[doc = " Compute the inverse of a scalar (modulo the group order), without constant-time guarantee."]
    pub fn secp256k1_scalar_inverse_var(r: *mut secp256k1_scalar, a: *const secp256k1_scalar);
}
extern "C" {
    #[doc = " Compute the complement of a scalar (modulo the group order)."]
    pub fn secp256k1_scalar_negate(r: *mut secp256k1_scalar, a: *const secp256k1_scalar);
}
extern "C" {
    #[doc = " Check whether a scalar equals zero."]
    pub fn secp256k1_scalar_is_zero(a: *const secp256k1_scalar) -> ::std::os::raw::c_int;
}
extern "C" {
    #[doc = " Check whether a scalar equals one."]
    pub fn secp256k1_scalar_is_one(a: *const secp256k1_scalar) -> ::std::os::raw::c_int;
}
extern "C" {
    #[doc = " Check whether a scalar, considered as an nonnegative integer, is even."]
    pub fn secp256k1_scalar_is_even(a: *const secp256k1_scalar) -> ::std::os::raw::c_int;
}
extern "C" {
    #[doc = " Check whether a scalar is higher than the group order divided by 2."]
    pub fn secp256k1_scalar_is_high(a: *const secp256k1_scalar) -> ::std::os::raw::c_int;
}
extern "C" {
    #[doc = " Conditionally negate a number, in constant time.\n Returns -1 if the number was negated, 1 otherwise"]
    pub fn secp256k1_scalar_cond_negate(
...
extern "C" {
    #[doc = " Find r1 and r2 such that r1+r2*2^128 = k."]
    pub fn secp256k1_scalar_split_128(
...
extern "C" {
    #[doc = " Multiply a and b (without taking the modulus!), divide by 2**shift, and round to the nearest integer. Shift must be at least 256."]
    pub fn secp256k1_scalar_mul_shift_var(
        r: *mut secp256k1_scalar,
        a: *const secp256k1_scalar,
        b: *const secp256k1_scalar,
...
extern "C" {
    #[doc = " If flag is true, set *r equal to *a; otherwise leave it. Constant-time.  Both *r and *a must be initialized."]
    pub fn secp256k1_scalar_cmov(
        r: *mut secp256k1_scalar,
        a: *const secp256k1_scalar,
        flag: ::std::os::raw::c_int,
    );
...
extern "C" {
    pub static secp256k1_fe_one: secp256k1_fe;
}
extern "C" {
    pub static secp256k1_const_beta: secp256k1_fe;
}
extern "C" {
    #[doc = " Normalize a field element. This brings the field element to a canonical representation, reduces\n  its magnitude to 1, and reduces it modulo field size `p`."]
    pub fn secp256k1_fe_normalize(r: *mut secp256k1_fe);
}
extern "C" {
    #[doc = " Weakly normalize a field element: reduce its magnitude to 1, but don't fully normalize."]
    pub fn secp256k1_fe_normalize_weak(r: *mut secp256k1_fe);
}
extern "C" {
    #[doc = " Normalize a field element, without constant-time guarantee."]
    pub fn secp256k1_fe_normalize_var(r: *mut secp256k1_fe);
}
extern "C" {
    #[doc = " Verify whether a field element represents zero i.e. would normalize to a zero value."]
    pub fn secp256k1_fe_normalizes_to_zero(r: *const secp256k1_fe) -> ::std::os::raw::c_int;
}
extern "C" {
    #[doc = " Verify whether a field element represents zero i.e. would normalize to a zero value,\n  without constant-time guarantee."]
    pub fn secp256k1_fe_normalizes_to_zero_var(r: *const secp256k1_fe) -> ::std::os::raw::c_int;
}
extern "C" {
    #[doc = " Set a field element equal to a small (not greater than 0x7FFF), non-negative integer.\n  Resulting field element is normalized; it has magnitude 0 if a == 0, and magnitude 1 otherwise."]
    pub fn secp256k1_fe_set_int(r: *mut secp256k1_fe, a: ::std::os::raw::c_int);
}
extern "C" {
    #[doc = " Sets a field element equal to zero, initializing all fields."]
    pub fn secp256k1_fe_clear(a: *mut secp256k1_fe);
}
extern "C" {
    #[doc = " Verify whether a field element is zero. Requires the input to be normalized."]
    pub fn secp256k1_fe_is_zero(a: *const secp256k1_fe) -> ::std::os::raw::c_int;
}
extern "C" {
    #[doc = " Check the \"oddness\" of a field element. Requires the input to be normalized."]
    pub fn secp256k1_fe_is_odd(a: *const secp256k1_fe) -> ::std::os::raw::c_int;
}
extern "C" {
    #[doc = " Compare two field elements. Requires magnitude-1 inputs."]
    pub fn secp256k1_fe_equal(
        a: *const secp256k1_fe,
        b: *const secp256k1_fe,
    ) -> ::std::os::raw::c_int;
}
extern "C" {
    #[doc = " Same as secp256k1_fe_equal, but may be variable time."]
    pub fn secp256k1_fe_equal_var(
        a: *const secp256k1_fe,
        b: *const secp256k1_fe,
    ) -> ::std::os::raw::c_int;
}
extern "C" {
    #[doc = " Compare two field elements. Requires both inputs to be normalized"]
    pub fn secp256k1_fe_cmp_var(
        a: *const secp256k1_fe,
        b: *const secp256k1_fe,
    ) -> ::std::os::raw::c_int;
}
extern "C" {
    #[doc = " Set a field element equal to 32-byte big endian value. If successful, the resulting field element is normalized."]
    pub fn secp256k1_fe_set_b32(
        r: *mut secp256k1_fe,
        a: *const ::std::os::raw::c_uchar,
    ) -> ::std::os::raw::c_int;
}
extern "C" {
    #[doc = " Convert a field element to a 32-byte big endian value. Requires the input to be normalized"]
    pub fn secp256k1_fe_get_b32(r: *mut ::std::os::raw::c_uchar, a: *const secp256k1_fe);
}
extern "C" {
    #[doc = " Set a field element equal to the additive inverse of another. Takes a maximum magnitude of the input\n  as an argument. The magnitude of the output is one higher."]
    pub fn secp256k1_fe_negate(
        r: *mut secp256k1_fe,
        a: *const secp256k1_fe,
        m: ::std::os::raw::c_int,
    );
...
extern "C" {
    #[doc = " Multiplies the passed field element with a small integer constant. Multiplies the magnitude by that\n  small integer."]
    pub fn secp256k1_fe_mul_int(r: *mut secp256k1_fe, a: ::std::os::raw::c_int);
}
extern "C" {
    #[doc = " Adds a field element to another. The result has the sum of the inputs' magnitudes as magnitude."]
    pub fn secp256k1_fe_add(r: *mut secp256k1_fe, a: *const secp256k1_fe);
}
extern "C" {
    #[doc = " Sets a field element to be the product of two others. Requires the inputs' magnitudes to be at most 8.\n  The output magnitude is 1 (but not guaranteed to be normalized)."]
    pub fn secp256k1_fe_mul(r: *mut secp256k1_fe, a: *const secp256k1_fe, b: *const secp256k1_fe);
}
extern "C" {
    #[doc = " Sets a field element to be the square of another. Requires the input's magnitude to be at most 8.\n  The output magnitude is 1 (but not guaranteed to be normalized)."]
    pub fn secp256k1_fe_sqr(r: *mut secp256k1_fe, a: *const secp256k1_fe);
}
extern "C" {
    #[doc = " If a has a square root, it is computed in r and 1 is returned. If a does not\n  have a square root, the root of its negation is computed and 0 is returned.\n  The input's magnitude can be at most 8. The output magnitude is 1 (but not\n  guaranteed to be normalized). The result in r will always be a square\n  itself."]
    pub fn secp256k1_fe_sqrt(r: *mut secp256k1_fe, a: *const secp256k1_fe)
        -> ::std::os::raw::c_int;
}
extern "C" {
    #[doc = " Sets a field element to be the (modular) inverse of another. Requires the input's magnitude to be\n  at most 8. The output magnitude is 1 (but not guaranteed to be normalized)."]
    pub fn secp256k1_fe_inv(r: *mut secp256k1_fe, a: *const secp256k1_fe);
}
extern "C" {
    #[doc = " Potentially faster version of secp256k1_fe_inv, without constant-time guarantee."]
    pub fn secp256k1_fe_inv_var(r: *mut secp256k1_fe, a: *const secp256k1_fe);
}
extern "C" {
    #[doc = " Convert a field element to the storage type."]
    pub fn secp256k1_fe_to_storage(r: *mut secp256k1_fe_storage, a: *const secp256k1_fe);
}
extern "C" {
    #[doc = " Convert a field element back from the storage type."]
    pub fn secp256k1_fe_from_storage(r: *mut secp256k1_fe, a: *const secp256k1_fe_storage);
}
extern "C" {
    #[doc = " If flag is true, set *r equal to *a; otherwise leave it. Constant-time.  Both *r and *a must be initialized."]
    pub fn secp256k1_fe_storage_cmov(
...
extern "C" {
    #[doc = " Set a group element equal to the point with given X and Y coordinates"]
    pub fn secp256k1_ge_set_xy(
        r: *mut secp256k1_ge,
...
extern "C" {
    #[doc = " Set a group element (affine) equal to the point with the given X coordinate, and given oddness\n  for Y. Return value indicates whether the result is valid."]
    pub fn secp256k1_ge_set_xo_var(
        r: *mut secp256k1_ge,
        x: *const secp256k1_fe,
...
extern "C" {
    #[doc = " Check whether a group element is the point at infinity."]
    pub fn secp256k1_ge_is_infinity(a: *const secp256k1_ge) -> ::std::os::raw::c_int;
}
extern "C" {
    #[doc = " Check whether a group element is valid (i.e., on the curve)."]
    pub fn secp256k1_ge_is_valid_var(a: *const secp256k1_ge) -> ::std::os::raw::c_int;
}
extern "C" {
    #[doc = " Set r equal to the inverse of a (i.e., mirrored around the X axis)"]
    pub fn secp256k1_ge_neg(r: *mut secp256k1_ge, a: *const secp256k1_ge);
}
extern "C" {
    #[doc = " Set a group element equal to another which is given in jacobian coordinates. Constant time."]
    pub fn secp256k1_ge_set_gej(r: *mut secp256k1_ge, a: *const secp256k1_gej);
}
extern "C" {
    #[doc = " Set a group element equal to another which is given in jacobian coordinates."]
    pub fn secp256k1_ge_set_gej_var(r: *mut secp256k1_ge, a: *mut secp256k1_gej);
}
extern "C" {
    #[doc = " Set a batch of group elements equal to the inputs given in jacobian coordinates"]
    pub fn secp256k1_ge_set_all_gej_var(r: *mut secp256k1_ge, a: *const secp256k1_gej, len: usize);
}
extern "C" {
    #[doc = " Bring a batch of inputs to the same global z \"denominator\", based on ratios between\n  (omitted) z coordinates of adjacent elements.\n\n  Although the elements a[i] are _ge rather than _gej, they actually represent elements\n  in Jacobian coordinates with their z coordinates omitted.\n\n  Using the notation z(b) to represent the omitted z coordinate of b, the array zr of\n  z coordinate ratios must satisfy zr[i] == z(a[i]) / z(a[i-1]) for 0 < 'i' < len.\n  The zr[0] value is unused.\n\n  This function adjusts the coordinates of 'a' in place so that for all 'i', z(a[i]) == z(a[len-1]).\n  In other words, the initial value of z(a[len-1]) becomes the global z \"denominator\". Only the\n  a[i].x and a[i].y coordinates are explicitly modified; the adjustment of the omitted z coordinate is\n  implicit.\n\n  The coordinates of the final element a[len-1] are not changed."]
    pub fn secp256k1_ge_table_set_globalz(
        len: usize,
        a: *mut secp256k1_ge,
...
extern "C" {
    #[doc = " Set a group element (affine) equal to the point at infinity."]
    pub fn secp256k1_ge_set_infinity(r: *mut secp256k1_ge);
}
extern "C" {
    #[doc = " Set a group element (jacobian) equal to the point at infinity."]
    pub fn secp256k1_gej_set_infinity(r: *mut secp256k1_gej);
}
extern "C" {
    #[doc = " Set a group element (jacobian) equal to another which is given in affine coordinates."]
    pub fn secp256k1_gej_set_ge(r: *mut secp256k1_gej, a: *const secp256k1_ge);
}
extern "C" {
    #[doc = " Compare the X coordinate of a group element (jacobian)."]
    pub fn secp256k1_gej_eq_x_var(
        x: *const secp256k1_fe,
...
extern "C" {
    #[doc = " Set r equal to the inverse of a (i.e., mirrored around the X axis)"]
    pub fn secp256k1_gej_neg(r: *mut secp256k1_gej, a: *const secp256k1_gej);
}
extern "C" {
    #[doc = " Check whether a group element is the point at infinity."]
    pub fn secp256k1_gej_is_infinity(a: *const secp256k1_gej) -> ::std::os::raw::c_int;
}
extern "C" {
    #[doc = " Set r equal to the double of a. Constant time."]
    pub fn secp256k1_gej_double(r: *mut secp256k1_gej, a: *const secp256k1_gej);
}
extern "C" {
    #[doc = " Set r equal to the double of a. If rzr is not-NULL this sets *rzr such that r->z == a->z * *rzr (where infinity means an implicit z = 0)."]
    pub fn secp256k1_gej_double_var(
        r: *mut secp256k1_gej,
        a: *const secp256k1_gej,
...
extern "C" {
    #[doc = " Set r equal to the sum of a and b. If rzr is non-NULL this sets *rzr such that r->z == a->z * *rzr (a cannot be infinity in that case)."]
    pub fn secp256k1_gej_add_var(
        r: *mut secp256k1_gej,
        a: *const secp256k1_gej,
...
extern "C" {
    #[doc = " Set r equal to the sum of a and b (with b given in affine coordinates, and not infinity)."]
    pub fn secp256k1_gej_add_ge(
        r: *mut secp256k1_gej,
        a: *const secp256k1_gej,
...
extern "C" {
    #[doc = " Set r equal to the sum of a and b (with the inverse of b's Z coordinate passed as bzinv)."]
    pub fn secp256k1_gej_add_zinv_var(
        r: *mut secp256k1_gej,
        a: *const secp256k1_gej,
        b: *const secp256k1_ge,
...
extern "C" {
    #[doc = " Set r to be equal to lambda times a, where lambda is chosen in a way such that this is very fast."]
    pub fn secp256k1_ge_mul_lambda(r: *mut secp256k1_ge, a: *const secp256k1_ge);
}
extern "C" {
    #[doc = " Clear a secp256k1_gej to prevent leaking sensitive information."]
    pub fn secp256k1_gej_clear(r: *mut secp256k1_gej);
}
extern "C" {
    #[doc = " Clear a secp256k1_ge to prevent leaking sensitive information."]
    pub fn secp256k1_ge_clear(r: *mut secp256k1_ge);
}
extern "C" {
    #[doc = " Convert a group element to the storage type."]
    pub fn secp256k1_ge_to_storage(r: *mut secp256k1_ge_storage, a: *const secp256k1_ge);
}
extern "C" {
    #[doc = " Convert a group element back from the storage type."]
    pub fn secp256k1_ge_from_storage(r: *mut secp256k1_ge, a: *const secp256k1_ge_storage);
}
extern "C" {
    #[doc = " If flag is true, set *r equal to *a; otherwise leave it. Constant-time.  Both *r and *a must be initialized."]
    pub fn secp256k1_gej_cmov(
        r: *mut secp256k1_gej,
        a: *const secp256k1_gej,
        flag: ::std::os::raw::c_int,
    );
...
extern "C" {
    #[doc = " If flag is true, set *r equal to *a; otherwise leave it. Constant-time.  Both *r and *a must be initialized."]
    pub fn secp256k1_ge_storage_cmov(
...
extern "C" {
    pub fn secp256k1_fe_from_signed62(r: *mut secp256k1_fe, a: *const secp256k1_modinv64_signed62);
}
extern "C" {
    pub fn secp256k1_fe_to_signed62(r: *mut secp256k1_modinv64_signed62, a: *const secp256k1_fe);
}
extern "C" {
    pub static secp256k1_const_modinfo_fe: secp256k1_modinv64_modinfo;
}
extern "C" {
    pub fn secp256k1_scalar_check_overflow(a: *const secp256k1_scalar) -> ::std::os::raw::c_int;
}
extern "C" {
    pub fn secp256k1_scalar_reduce(
        r: *mut secp256k1_scalar,
        overflow: ::std::os::raw::c_uint,
    ) -> ::std::os::raw::c_int;
}
extern "C" {
    pub fn secp256k1_scalar_reduce_512(r: *mut secp256k1_scalar, l: *const u64);
}
extern "C" {
    pub fn secp256k1_scalar_mul_512(
        l: *mut u64,
        a: *const secp256k1_scalar,
        b: *const secp256k1_scalar,
    );
...
extern "C" {
    pub fn secp256k1_scalar_from_signed62(
        r: *mut secp256k1_scalar,
        a: *const secp256k1_modinv64_signed62,
    );
}
extern "C" {
    pub fn secp256k1_scalar_to_signed62(
        r: *mut secp256k1_modinv64_signed62,
        a: *const secp256k1_scalar,
    );
}
extern "C" {
    pub static secp256k1_const_modinfo_scalar: secp256k1_modinv64_modinfo;
}
extern "C" {
    pub static secp256k1_scalar_one: secp256k1_scalar;
}
extern "C" {
    pub static secp256k1_scalar_zero: secp256k1_scalar;
}
extern "C" {
    #[doc = " The Secp256k1 curve has an endomorphism, where lambda * (x, y) = (beta * x, y), where\n lambda is:"]
    pub static secp256k1_const_lambda: secp256k1_scalar;
}
extern "C" {
    pub static secp256k1_ge_const_g: secp256k1_ge;
}
extern "C" {
    pub static secp256k1_fe_const_b: secp256k1_fe;
}
extern "C" {
    pub fn secp256k1_ge_set_gej_zinv(
        r: *mut secp256k1_ge,
        a: *const secp256k1_gej,
...
extern "C" {
    #[doc = " Double multiply: R = na*A + ng*G"]
    pub fn secp256k1_ecmult(
        r: *mut secp256k1_gej,
        a: *const secp256k1_gej,
...
extern "C" {
    pub static secp256k1_pre_g: [secp256k1_ge_storage; 8192usize];
}
extern "C" {
    pub static secp256k1_pre_g_128: [secp256k1_ge_storage; 8192usize];
}
#[repr(C)]
#[derive(Debug, Copy, Clone)]
...
extern "C" {
    pub static mut secp256k1_ecmult_gen_prec_table: [[secp256k1_ge_storage; 16usize]; 64usize];
}
